...
BEGIN	
	...
	BEGIN
		...
		BEGIN
			...
			VALUES (@dwUserID, @lRoomCard, @Fee, 0, 0, 3, @Currency, @lGold, '创建房间消耗房卡', @strClientIP, GETDATE())
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			INSERT INTO RYRecordDB..RecordRoomCard(SourceUserID, SBeforeCard, RoomCard, TargetUserID, TBeforeCard, TypeID, Currency, Gold, Remarks, ClientIP, CollectDate)
			VALUES (@dwUserID, @lRoomCard + @Fee, @Fee, 0, 0, 5, @Currency, @lGold, '解散退还房卡', @strClientIP, GETDATE())
