...
//平台常量
const TCHAR szProduct[]=TEXT("当当棋牌");							//产品名字
const TCHAR szPlazaClass[]=TEXT("WHGDXYCQPGamePlaza");						//广场类名
const TCHAR szProductKey[]=TEXT("WHGDXYCQPGamePlatform");					//产品主键

//地址定义
const TCHAR szCookieUrl[]=TEXT("http://www.ad2018.net");					//记录地址
const TCHAR szLogonServer[]=TEXT("www.ad2018.net");						//登录地址
const TCHAR szPlatformLink[]=TEXT("http://www.ad2018.net");				//平台网站
