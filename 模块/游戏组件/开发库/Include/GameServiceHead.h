...
public:
	...
	//视频ID
	virtual	void  SetVideoNumber(CHAR *szVideoNumber)=NULL;
	virtual CHAR* GetVideoNumber()=NULL;
	//属性信息
public:
	//用户性别
...
public:
	...
	//写入录像
	virtual bool WriteTableVideoPlayer(DWORD dwUserID,CHAR *pVideoNumber) = NULL;
	//写入录像
	virtual bool WriteTableVideoData(CHAR *pVideoNumber,WORD wServerID,WORD wTableID,BYTE *pVideoData,WORD wSize) = NULL;
