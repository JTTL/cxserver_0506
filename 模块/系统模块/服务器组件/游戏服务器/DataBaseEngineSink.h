...
protected:
	...
	//录像玩家信息
	bool OnRequestWriteVideoPlayerInfo(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	//录像数据信息
	bool OnRequestWriteVideoDataInfo(DWORD dwContextID, VOID * pData, WORD wDataSize, DWORD &dwUserID);
	//签到服务
protected:
	//加载签到
