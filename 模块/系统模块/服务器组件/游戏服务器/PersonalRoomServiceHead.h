...
public:
	...
	virtual bool OnEventGameEnd(WORD wTableID,  WORD wChairCount, DWORD dwDrawCountLimit, DWORD & dwPersonalPlayCount, int nSpecialInfoLen, byte * cbSpecialInfo, tagPersonalUserScoreInfo * PersonalUserScoreInfo)=NULL;
