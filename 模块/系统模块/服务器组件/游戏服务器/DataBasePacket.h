...
#define DBR_GR_WRITE_VIDEO_PLAYER_INFO		1400
#define DBR_GR_WRITE_VIDEO_DATA_INFO		1401
...
struct DBR_GR_WriteVideoData
{
	...
	WORD							wServerID;
	WORD							wTableID;	
	BYTE							cbVideoData[4000];					//录像数据	
	WORD							wVideoSize;							//实际长度
};
