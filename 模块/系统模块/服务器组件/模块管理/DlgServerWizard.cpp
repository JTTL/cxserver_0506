...
BOOL CDlgServerOptionItem2::OnInitDialog()
{
	...
	//支持回放
	bool bPlayBack = CServerRule::IsSuportPlayBack(m_pGameServiceOption->dwServerRule);
	((CButton*)GetDlgItem(IDC_SERVER_SUPORT_VIDEO))->SetCheck((bPlayBack==TRUE)?BST_CHECKED:BST_UNCHECKED);
