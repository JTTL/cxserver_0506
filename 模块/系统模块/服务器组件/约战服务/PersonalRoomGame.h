...
protected:
	...
	//比赛配置
protected:
	tagPersonalRoomOption *				m_pPersonalRoomOption;					//比赛配置	
...
public:
	 ...
	 //游戏结束
	 virtual bool OnEventGameEnd(WORD wTableID,  WORD wChairCount, DWORD dwDrawCountLimit, DWORD & dwPersonalPlayCount, int nSpecialInfoLen, byte * cbSpecialInfo, tagPersonalUserScoreInfo * PersonalUserScoreInfo);
